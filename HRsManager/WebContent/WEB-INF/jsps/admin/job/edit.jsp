...
<body>
	<form id="addJobName" name="Form1"
		action="${pageContext.request.contextPath}/updateJobName?id=${key_job_msg.jid}"
		method="post">
		&nbsp;
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td class="ta_01" align="center" bgColor="#afd1f3" colSpan="4"
					height="26"><strong><STRONG>修改职位名称</STRONG> </strong></td>
			</tr>
			...
			<tr>
				...
				<td width="18%" bgColor="#ffffff"><input type="text"
					name="jobname" value="${key_job_msg.jname}" id="jobname" /></td>
